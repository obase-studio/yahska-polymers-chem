          ...
          {products.length > 0 ? (
            <div className="space-y-4">
              {products.map((product: any) => (
                <Card key={product.id} className="border-2 shadow-sm hover:shadow-md transition-shadow bg-white">
                  <CardContent className="p-8">
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0 pr-6">
                        <div className="flex items-start gap-4 mb-4">
                          <div className="flex-1">
                            <h3 className="font-semibold text-lg mb-3 truncate">{product.name}</h3>
                            <Badge variant="secondary" className="text-sm px-4 py-2">{product.category_name}</Badge>
                          </div>
                        </div>
            ...
            <div className="text-center py-16">
              ...
              <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                Get started by adding your first product to the catalog. You can manage prices, descriptions, and categories.
              </p>
