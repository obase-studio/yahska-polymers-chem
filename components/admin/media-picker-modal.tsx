...
export function MediaPickerModal({
  ...
  const filteredFiles = mediaFiles.filter((file) => {
    ...
    const matchesType =
      !imagesOnly || isImageFile(file.mime_type, file.original_name);
  ...
  const handleSelect = (e: React.MouseEvent) => {
    ...
    if (selectedFile) {
      ...
      // Add a small delay to prevent dialog closing issues
      setTimeout(() => {
        onClose();
      }, 100);
    }
  ...
  const handleCardClick = (file: MediaFile) => {
    console.log("Card clicked:", file.original_name);
  ...
  return (
    // Using z-[60] to ensure this modal appears above Dialog components (z-50)
    <div
    ...
    >
      <div
        className="bg-background rounded-lg max-w-6xl w-full max-h-[90vh] overflow-hidden flex flex-col"
        onClick={(e) => {
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              onClick={() => {
                ...
                setShowUploadTab(!showUploadTab);
              }}
          ...
          {showUploadTab ? (
            ...
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Upload files from your computer or paste a URL
                </p>
              </div>
